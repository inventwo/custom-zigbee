...
const device = {
    ...
    fromZigbee: [fz.ignore_basic_report, fz.temperature, fz.ptvo_humidity, fz.ptvo_switch_analog_input, fz.ptvo_on_off, fz.ptvo_multistate_action, fz.ptvo_on_off_config,],
    ...
    exposes: [e.temperature().withEndpoint('l1'),
      ...
      exposes.numeric('l2', ea.STATE).withDescription('Feuchtigkeit links'),
      exposes.numeric('l3', ea.STATE).withDescription('Feuchtigkeit rechts'),
      e.switch().withEndpoint('l4'),
      e.switch().withEndpoint('l5'),
      e.contact().withEndpoint('l6'),
      e.contact().withEndpoint('l7'),
      ...ptvo_on_off_config_exposes('l6'),
      ...ptvo_on_off_config_exposes('l7'),
],
    meta: {
        multiEndpoint: true,
        binaryEndpoints: {'l6': 'contact', 'l7': 'contact', }, 
    },
    endpoint: (device) => {
        return {
